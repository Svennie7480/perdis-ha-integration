...
- 🚌 **Dienstplan** als Home Assistant Kalender (3 Monate voraus)
- 📅 **Dienstdetail** – komplette Tagesübersicht mit Wendezeiten und Pausen
- 🏖️ **Urlaubssalden** – Rest, Anspruch, Plan, Zusatzurlaub
- ⏱️ **Überstunden & Salden** – Überstunden, Langzeitkonto, TVK Privat, Soll/Ist
- 📬 **Letzte Nachricht** – Betreff und Text der neuesten Nachricht
- 🔨 **Dienstversteigerung** – verfügbare Dienste mit Leitstellen-Alarm
- 🔔 **Automatische Benachrichtigung** bei Leitstellen-Diensten (800–899) in der Versteigerung
